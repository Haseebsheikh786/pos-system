      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="mb-12">
            ...
            <p className="text-gray-400 text-lg">Last updated: December 14, 2024</p>
          </div>
          ...
          <div className="prose prose-invert max-w-none space-y-8">
            <div className="bg-[#0A0A0A] border border-[#D4AF37] rounded-lg p-8">
              ...
              <p className="text-gray-400 leading-relaxed">
                By accessing and using POS System ("the Service"), you accept and agree to be bound by the terms and
                provision of this agreement. If you do not agree to these terms, you should not use the Service.
              </p>
            </div>
            ...
            <div className="bg-[#0A0A0A] border border-[#D4AF37] rounded-lg p-8">
              ...
              <p className="text-gray-400 leading-relaxed mb-4">
                Permission is granted to temporarily access and use the Service for personal or commercial use. This
                license shall automatically terminate if you violate any of these restrictions and may be terminated by
                POS System at any time.
              </p>
              <p className="text-gray-400 leading-relaxed">Under this license you may not:</p>
            ...
            <div className="bg-[#0A0A0A] border border-[#D4AF37] rounded-lg p-8">
              ...
              <p className="text-gray-400 leading-relaxed mb-4">
                If you register for a paid subscription, you agree to pay all fees and charges associated with your
                account in accordance with the pricing and payment terms presented to you during the purchase process.
              </p>
              <p className="text-gray-400 leading-relaxed mb-4">
                All fees are quoted in U.S. Dollars and are non-refundable unless otherwise specified. We reserve the
                right to change our pricing at any time, but price changes will not affect any subscription period that
            ...
            <div className="bg-[#0A0A0A] border border-[#D4AF37] rounded-lg p-8">
              ...
              <p className="text-gray-400 leading-relaxed">
                We strive to provide 99.9% uptime for our Service. However, we do not guarantee that the Service will be
                uninterrupted or error-free. We reserve the right to suspend or terminate the Service for maintenance,
                updates, or any other reason at our discretion.
              </p>
            </div>
            ...
            <div className="bg-[#0A0A0A] border border-[#D4AF37] rounded-lg p-8">
              ...
              <p className="text-gray-400 leading-relaxed">
                ...
                property of POS System and its licensors. The Service is protected by copyright, trademark, and other
            ...
            <div className="bg-[#0A0A0A] border border-[#D4AF37] rounded-lg p-8">
              ...
              <p className="text-gray-400 leading-relaxed">
                In no event shall POS System, nor its directors, employees, partners, agents, suppliers, or affiliates,
