        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Card className="bg-background border-primary hover:border-primary/70 transition-colors">
            <CardContent className="p-6">
              ...
              <h3 className="text-xl font-semibold  mb-2">Fast Billing</h3>
          ...
          <Card className="bg-background border-primary hover:border-primary/70 transition-colors">
            <CardContent className="p-6">
              ...
              <h3 className="text-xl font-semibold  mb-2">Customer Credit</h3>
              <p className="text-gray-400 leading-relaxed">
          ...
          <Card className="bg-background border-primary hover:border-primary/70 transition-colors">
            <CardContent className="p-6">
              <div className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center mb-4">
                <ThumbsUp className="text-primary" size={24} />
              </div>
